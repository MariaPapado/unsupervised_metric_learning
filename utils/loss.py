...
def cm_InfoNce_loss(change, no_change, info_loss):
    ...
    for i in range(1):
        ...
        img1_c  = change_s*(change_s.detach()>no_change_s.detach()) ##0 sta no change pixels
        img2_c  = change_s*(change_s.detach()>no_change_s.detach())  ##0 sta no change pixels
        img1_nc = no_change_s*(change_s.detach()<no_change_s.detach())  ##0 sta change pixels
        img2_nc = no_change_s*(change_s.detach()<no_change_s.detach()) ##0 sta change pixels
